...
export class Bound extends PureComponent<QueryBuilderProps, State> {
  state: State = {
    selectedOption: {},
  };
  ...
  constructor(props: QueryBuilderProps) {
    ...
    this.selectOptions = this.buildSelectOptions(['Polygon', 'Radius', 'Rectangular']);
  ...
  render() {
    ...
    return (
      <>
        ...
        <div>
          {selectedOption.value === 'polygon' && (
            <Polygon options={builderOptions} onOptionsChange={this.onOptionsChange} />
          )}
          {selectedOption.value === 'radius' && (
            <Radius options={builderOptions} onOptionsChange={this.onOptionsChange} />
          )}
          {selectedOption.value === 'rectangular' && (
            <Rectangular options={builderOptions} onOptionsChange={this.onOptionsChange} />
          )}
        </div>
      </>
    );
